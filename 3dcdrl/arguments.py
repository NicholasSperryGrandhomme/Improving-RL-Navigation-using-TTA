...
def parse_a2c_args():
    ...
    # =========================================================================
    paa('--use_tta', default=False, help='Use Test Time Adaptation. If use_tta is set on, but \
                                          use_rot and use_gray are OFF, an ablation experiment will be conducted', action='store_true')
    paa('--use_rot', default=False, help='Evaluate Agent using TTA with rotation prediction', action='store_true')
    paa('--use_gray', default=False, help='Evaluate Agent using TTA with grayscale prediction', action='store_true')
    ...
    paa('--scenario_dir',       default='3dcdrl/scenarios/',           help='location of scenarios',  type=str)    
